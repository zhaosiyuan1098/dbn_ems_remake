...
class Loader:
    ...
    def load_model(self, model_name):
        ...
        # x_probas_valid, y_valid,_ = learner.get_preds(dl=dls.valid, with_decoded=True)  #这里是原来的的读取
        ...
        x_probas_valid, y_valid,_ = learner.get_preds(dl=test_dl, with_decoded=True)
